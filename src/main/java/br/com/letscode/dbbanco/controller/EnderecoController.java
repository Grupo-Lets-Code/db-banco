...
public class EnderecoController {
    ...
    public void createEndereco(String logradouro, String numero, String cidade, String bairro, String uf, String pais, int cep, Cliente cliente_id){
        var criarEnd = new Endereco(logradouro,numero,cidade,bairro,uf,pais,cep,cliente_id);
